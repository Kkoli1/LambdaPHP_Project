...
<body>
    ...
    <section class="grid-page-2">
        ...
        <div class="center">
            <form action="" method = "POST" enctype="multipart/form-data">
                <div class="manage-items-form-container">
                    ...
                    <div class="item-row2">
                        ...
                        <input type="text" name="item_stock" id="item-stock">
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit'])){
                            ...
                            $insert = "INSERT INTO inventory (business_id, item_name, item_description, category, price, stock) VALUES ($item_seller, '$item_name', '$item_info', 'ECOMMERCE', $item_price, $item_stock)";
            ...
            <form action="manage-online-store.php" method="POST" id="delete-form">
