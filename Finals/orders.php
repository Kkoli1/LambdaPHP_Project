...
if (isset($_SESSION['user'])){
    ...
    $query = "SELECT order_id FROM customer_orders where customer_id = $customer_id";
        ...
        <div class="center">
            ...
            <?php 
                ...
                while ($qValue = mysqli_fetch_assoc($result)){
                    $order_id = $qValue['order_id'];
                    $orderQuery = "SELECT * FROM orders WHERE order_id = $order_id";
                    $orderResult = mysqli_query($conn, $orderQuery);
                    while ($orderInfo = mysqli_fetch_assoc($orderResult)) {
            ...
            <div class="cart-item">
                ...
                <div class="check-status">
                    <?php 
                    $link = "order-status.php?product_id=$product_id&order_id=$order_id"
                    ?>
